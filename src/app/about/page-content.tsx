  ...
  return (
    <div className="space-y-6">
      ...
      <div className="surface-divider pt-6">
        <h2 className="mb-3 font-mono text-xl font-bold text-zinc-900 dark:text-white">Background</h2>
        <p className="text-base leading-relaxed text-zinc-600 dark:text-zinc-300">
      ...
      <div className="surface-divider pt-6">
        <h2 className="mb-3 font-mono text-xl font-bold text-zinc-900 dark:text-white">Outside of Coding</h2>
        <p className="text-base leading-relaxed text-zinc-600 dark:text-zinc-300">
      ...
      <div className="surface-divider pt-6">
        <h2 className="mb-3 font-mono text-xl font-bold text-zinc-900 dark:text-white">My Approach</h2>
        <p className="text-base leading-relaxed text-zinc-600 dark:text-zinc-300">
      ...
      <div className="surface-divider mt-6 pt-6">
        <p className="text-center text-base leading-relaxed text-zinc-600 dark:text-zinc-300">
