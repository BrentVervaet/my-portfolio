...
tags: ["Internship", "Odoo", "Python", "AWS", "AI", "Full-Stack"]
---

# My Last Day at Endoo: Reflecting on 14 Weeks of Building Manual.to for Odoo
...
**✅ Progress Tracking** - Visual progress bars for multi-step manuals  
...
**Result:** Translation time dropped from ~30s to ~5s per manual.
...
- 🔄 Asked for category filtering in portal
...
- **Friendly and welcoming** - Everyone willing to assist
...
- Portal page load: ~1.2s (including images)
- Video playback start: ~500ms

**Translation Performance:**
- Before optimization: ~30s per manual
- After optimization: ~5s per manual
- TTS generation: ~3s per step (Polly)
